...
//{
uint32_t PN532::authenticateBlock(uint8_t cardnumber /*1 or 2*/,uint32_t cid /*Card NUID*/, uint8_t blockaddress /*0 to 63*/,uint8_t authtype/*Either KEY_A or KEY_B */, uint8_t k0, uint8_t k1, uint8_t k2, uint8_t k3, uint8_t k4, uint8_t k5 ) 
{
  pn532_packetbuffer[0] = PN532_INDATAEXCHANGE;
  ...
  pn532_packetbuffer[4] = k0;
  pn532_packetbuffer[5] = k1;
  pn532_packetbuffer[6] = k2;
  pn532_packetbuffer[7] = k3;
  pn532_packetbuffer[8] = k4;
  pn532_packetbuffer[9] = k5;
